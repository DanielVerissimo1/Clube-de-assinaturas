...
**Encantos Literários** é um desafio prático desenvolvido durante a formação Full-Stack da **Rocketseat**. O projeto consiste em uma Landing Page para um clube de assinatura literário, com foco em animações CSS para criar uma experiência envolvente e interativa.

---

## 📸 Visualização do Projeto:

<img alt="preview" src="/Thumbnail (4).png" />
